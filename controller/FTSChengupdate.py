...
# peramalan = []
# for i in fuzzifikasi:
#     if i in dict_defuzzifikasi:
#         peramalan.append(dict_defuzzifikasi[i])
#     else:
#         i_number = int(i[1:])
#         closest_key = min(
#             dict_defuzzifikasi.keys(),
#             key=lambda x: abs(int(x[1:]) - i_number),
#         )
#         peramalan.append(dict_defuzzifikasi[closest_key])
#         print(i, "->", closest_key, dict_defuzzifikasi[closest_key])
# opsi <
# i_number = int(i[1:])
# possible_keys = [
#     key for key in dict_defuzzifikasi.keys() if int(key[1:]) > i_number
# ]
# if possible_keys:
#     closest_key = min(
#         possible_keys,
#         key=lambda x: int(x[1:]) - i_number,
#     )
#     print(i, "->", closest_key, dict_defuzzifikasi[closest_key])
#     peramalan.append(dict_defuzzifikasi[closest_key])
# else:
#     peramalan.append(dict_nilai_tengah[i])
#     print(i, "->", dict_nilai_tengah[i])
# print("done")Z
